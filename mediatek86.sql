...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 11 nov. 2024 à 15:41
...
('10002', 417, '2024-11-08', '', '00001'),
('10002', 418, '2021-12-01', '', '00001'),
('10003', 12, '2024-11-09', '', '00001'),
...
CREATE TABLE IF NOT EXISTS `suivi` (
  ...
  `idCommandeDocument` varchar(5) NOT NULL,
  `etape` text,
  PRIMARY KEY (`id`),
  KEY `fk_suivi_commandedocument` (`idCommandeDocument`)
...
INSERT INTO `suivi` (`id`, `idCommandeDocument`, `etape`) VALUES
(1, '2', 'commande en cours de livraison');
...
--
ALTER TABLE `suivi`
  ADD CONSTRAINT `fk_suivi_commandedocument` FOREIGN KEY (`idCommandeDocument`) REFERENCES `commandedocument` (`id`),
  ADD CONSTRAINT `suivi_ibfk_1` FOREIGN KEY (`idCommandeDocument`) REFERENCES `commandedocument` (`id`);
COMMIT;
